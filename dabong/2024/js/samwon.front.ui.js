...
, front = {
  ...
  common: {
      ...
      init: function() {
          var _this = this;
          if (this.header = $("#dHead").length > 0 ? $("#dHead") : null,
      ...
      gnb: {
          init: function() {
              ...
              $(document).on("mouseenter mouseleave", ".gnb-list-cell", (function(e) {
                  "mouseenter" == e.type ? ($("#dHead").hasClass("state-search") && _this.searchToggle(),
                  $("#dHead").addClass("gray state-gnb actived"),
                  $(this).addClass("hover")) : "mouseleave" == e.type && ($("#dHead").removeClass("gray state-gnb actived"),
                  $(this).removeClass("hover"))
              }
              )),
              $(document).on("click", ".btn-gnb-menu-open", (function() {
                  $("#dHead").hasClass("state-search") && _this.searchToggle(),
                  _this.allMenuToggle()
              }
              )),
          ...
          allMenuToggle: function() {
              $("#dHead").hasClass("state-sitemap") ? ($("#dHead").removeClass("gray state-sitemap actived"),
              $("html").removeClass("fix")) : ($("#dHead").addClass("gray state-sitemap actived"),
              $("html").addClass("fix"))
          }
      },
      scroll: function() {
          ...
          if (this.header) {
              ...
              front.stage.top <= 1 ? this.header.removeClass("up down") : ((this.header.hasClass("scroll") || this.header.hasClass("down")) && front.stage.ptop > front.stage.top && this.header.removeClass("down").addClass("up"),
              (this.header.hasClass("scroll") || this.header.hasClass("up")) && front.stage.ptop < front.stage.top && this.header.removeClass("up").addClass("down")),
              front.stage.ptop = front.stage.top
          }
          if (this.pageUI) {
              var pointY = 100;
              front.stage.top >= 100 ? (front.btnTopFlag || this.pageUI.addClass("actived"),
              front.btnTopFlag = !0) : (front.btnTopFlag && this.pageUI.removeClass("actived"),
              front.btnTopFlag = !1);
      ...
      tabContentSort: function(parents, index) {
          parents.find(".panel-tab > li ").each((function() {
              $(this).index() == index ? $(this).addClass("actived").find(".btn-tab-list-item").attr("title", "선택됨") : $(this).removeClass("actived").find(".btn-tab-list-item").removeAttr("title")
          }
          )),
  ...
  form: {
      ...
      fileRead: function(_elem) {
          _elem.nextElementSibling && _elem.nextElementSibling.classList.contains("read-file") ? "" != _elem.value && (_elem.nextElementSibling.value = _elem.value) : alert("구조 재확인 필요")
      },
  ...
  pop: {
      ...
      close: function(_item) {
          ...
          ($element = "string" == typeof _item ? document.querySelector("#" + _item) : _this.closest(_item, "layer-pop-wrap")) && (this.prevElement = this.prevElements[this.prevElements.length - 1],
      ...
      toastOpen: function(_id) {
          var _this = this;
          _this.toastPopActive || (_this.toastPopTimer && clearTimeout(_this.toastPopTimer),
  ...
  accordion: {
      init: function() {
          $(".accordion-list").length > 0 && ($(document).on("click", ".btn-accordion-menu", (function() {
      ...
      toggle: function(_obj) {
          var parentsElement;
          _obj.parents(".accordion-list").find(".accordion-cell").each((function() {
              $(this).index() == _obj.parents(".accordion-cell").index() && ($(this).hasClass("actived") ? $(this).removeClass("actived").find(".accordion-content").stop(!0).slideUp(250) : $(this).addClass("actived").find(".accordion-content").stop(!0).slideDown(250))
          }
          ))
      }
  }
  ...
  set: function(_options) {
      function dropdowns(_options) {
          ...
          this.container.find(".btn-dropdown-nav").on("click", (function() {
              _this.container.hasClass("actived") ? _this.container.removeClass("actived") : (_this.global.close(),
          ...
          this.init = function() {
              ...
              this.container.find(".dropdown-list .dropdown-cell").each((function() {
                  $(this).hasClass("actived") && (_this.value = $(this).find(".btn-dropdown-item").html(),
                  _this.setValue(),
                  i++)
              }
              )),
              0 == i && (this.container.find(".dropdown-list .dropdown-cell:eq(0)").addClass("actived").siblings().removeClass("actived"),
...
, product = {
  ...
  init: function() {
      ...
      this.visualSliderElement = this.container.find(".product-view-visual .slider-visual").length > 0 ? this.container.find(".product-view-visual .slider-visual") : null,
      $("#wrap").addClass("product"),
      this.visualSliderElement && (this.visualSliderElement.find(".swiper-slide").length > 1 ? this.visualSlider = new Swiper(this.visualSliderElement.find(".swiper")[0],{
          loop: !0,
          simulateTouch: !1,
          observeParents: !0,
...
, mouseDirection = {
  ...
  getHoverDirection: function(event) {
      var directions = ["top", "right", "bottom", "left"], item = event.currentTarget, w = item.offsetWidth, h = item.offsetHeight, x = (event.clientX - item.getBoundingClientRect().left - w / 2) * (w > h ? h / w : 1), y = (event.clientY - item.getBoundingClientRect().top - h / 2) * (h > w ? w / h : 1), d;
...
, paperLab = {
  ...
  init: function() {
      ...
      window.addEventListener("load", (function() {
          _this.resize(),
          "" != $WINDOW.getParameter("pageIndex") && (_this.pageCur = parseInt($WINDOW.getParameter("pageIndex")),
          _this.pageSort(_this.pageCur))
      }
      )),
  ...
  overview: {
      ...
      init: function() {
          ...
          this.len > 1 ? (this.elements.sliderUI.find(".btn-slider-prev").on("click", (function() {
      ...
      sliderClick: function(index) {
          this.cur != index && (this.state || (this.prev = this.cur,
          this.cur = index,
          this.dir = this.prev > this.cur ? "left" : "right",
          this.sliderSort(),
          this.state = !0))
      },
      sliderSort: function() {
          if (this.len > 1) {
              ...
              this.setStyle(),
              0 == _cur ? this.elements.sliderUI.find(".btn-slider-prev").addClass("hide") : _cur >= _len - 1 ? this.elements.sliderUI.find(".btn-slider-next").addClass("hide") : (this.elements.sliderUI.find(".btn-slider-prev").removeClass("hide"),
              this.elements.sliderUI.find(".btn-slider-next").removeClass("hide")),
              this.elements.sliderUI.find(".value").html(_cur + 1),
              this.elements.sliderUI.find(".len").html(_len),
              this.firstState && setTimeout((function() {
                  _this.state = !1
              }
              ), this.delay),
              this.firstState = !0
  ...
  faq: {
      ...
      init: function() {
          ...
          this.len > 1 && this.elements.tabs.find(".btn-paperlab-faq-nav").on("click", (function() {
      ...
      sliderClick: function(index) {
          this.cur != index && (this.state || (this.cur = index,
          this.sliderSort(),
          this.state = !0))
      },
      sliderSort: function() {
...
, relatedCompany = {
  ...
  sceneSet: function() {
      ...
      this.tweeners.tweener12.fromTo(samwongallery.find(".item-cover .item-inner"), {
          y: 0
      }, {
          y: stageH - samwongallery.find(".item-cover .item-inner").innerHeight(),
          ease: Linear.easeNone
      }, 0),
      this.tweeners.tweener12.fromTo(samwongallery.find(".item-view .item-inner"), {
          y: 0
      }, {
      ...
      this.scenes.scene12.offset(.3 * stageH),
      ...
      this.scenes.scene20.on("progress", (function(e) {
          ...
          gsap.set(papermoreClipElement, {
              "clip-path": "polygon(50% " + point2 + "%, " + point3 + "% " + point4 + "%, " + point5 + "% " + point6 + "%, 50% " + point8 + "%, " + point9 + "% " + point10 + "%, " + point11 + "% " + point12 + "%)"
          })
      }
      )),
      ...
      this.tweeners.tweener22.fromTo(papermore.find(".item-cover .item-inner"), {
          y: 0
      }, {
          y: stageH - papermore.find(".item-cover .item-inner").innerHeight(),
          ease: Linear.easeNone
      }, 0),
      this.tweeners.tweener22.fromTo(papermore.find(".item-view .item-inner"), {
          y: 0
      }, {
      ...
      this.scenes.scene22.offset(.3 * stageH),
      ...
      this.tweeners.tweener32.fromTo(jiheonsf.find(".item-cover .item-inner"), {
          y: 0
      }, {
          y: stageH - jiheonsf.find(".item-cover .item-inner").innerHeight(),
          ease: Linear.easeNone
      }, 0),
      this.tweeners.tweener32.fromTo(jiheonsf.find(".item-view .item-inner"), {
          y: 0
      }, {
      ...
      this.scenes.scene32.offset(.3 * stageH),
      ...
      this.scenes.scene40.on("progress", (function(e) {
          ...
          gsap.set(koreacnsClipElement, {
              "clip-path": "polygon(" + point1 + "% " + point2 + "%, " + point3 + "% " + point4 + "%, " + point5 + "% " + point6 + "%, " + point7 + "% " + point8 + "%)"
          })
      }
      )),
      ...
      this.tweeners.tweener42.fromTo(koreacns.find(".item-cover .item-inner"), {
          y: 0
      }, {
          y: stageH - koreacns.find(".item-cover .item-inner").innerHeight(),
          ease: Linear.easeNone
      }, 0),
      this.tweeners.tweener42.fromTo(koreacns.find(".item-view .item-inner"), {
          y: 0
      }, {
      ...
      this.scenes.scene42.offset(.3 * stageH),
...
, main = {
  ...
  init: function() {
      var _this = this;
      if (this.controller = new ScrollMagic.Controller,
      front.common.header.addClass("fadeIn"),
      ...
      this.middleBannerElement.find(".swiper-view .swiper-slide").length > 1) {
          ...
          this.middleBannerElement.find(".loop-words-wrap .loop-words-cell").each((function() {
              for (var _html = $(this).find(".item-inner").html(), i = 0; i < 2; i++)
                  $(this).find(".item-inner").append(_html);
  ...
  sceneSet: function() {
      ...
      $(".parallax-items").each((function() {
          ...
          $tweener.fromTo($parents.find(".parallax-parents"), {
              y: $randomY + "px"
          }, {
              y: -1 * $randomY + "px",
              ease: Linear.easeNone
          ...
          $scene.duration($parents.height() + stageH),
          $scene.setTween($tweener)
      }
      )),
      $(".main-paper-lab").find(".list-cell").each((function() {
          var $element = $(this)
      ...
      this.tweeners.tweener31.fromTo($(".main-new .headline"), {
          alpha: 1,
          filter: "blur(0px)"
      }, {
          alpha: .03,
      ...
      this.tweeners.tweener31.fromTo($(".main-new .slider-body .slider-view"), {
          y: "-40%"
      }, {
          y: "0%",
          ease: Linear.easeNone
...
, mainPointer = {
  ...
  resize: function() {},
  sliderNext: function() {
      mainPointer.state || (mainPointer.prev = mainPointer.cur,
  ...
  sort: function(index) {
      ...
      mainPointer.elements.body.find(".slider-items").each((function() {
          var $element = $(this)
            ...
            , $zIndex = -1
            , $scale = 1;
          $(this).index() < index ? ($index = mainPointer.len - Math.abs($(this).index() - index),
          $vIndex = -1 * Math.abs($(this).index() - index),
          $zIndex = -1 * Math.abs($(this).index() - index)) : $(this).index() > index ? ($index = ++i,
          $vIndex = i,
          $zIndex = -1 * i) : $(this).index() == index && ($index = 0,
          $vIndex = 0,
          $zIndex = 0),
          $element.attr({
              "data-index": $index,
          ...
          $element.index() == mainPointer.cur ? $element.removeClass("prev").addClass("actived") : $element.index() == mainPointer.prev ? ($element.removeClass("actived").addClass("prev"),
          $vIndex < 0 && ($element.css({
          ...
          ), 600))) : $element.removeClass("actived prev")
      }
      )),
      mainPointer.elements.stage.find(".btn-slider-nav.prev").show(),
      mainPointer.elements.stage.find(".btn-slider-nav.next").show(),
      0 == mainPointer.cur && (mainPointer.elements.stage.find(".btn-slider-nav.prev").hide(),
      mainPointer.elements.stage.find(".btn-slider-nav.next").show()),
      mainPointer.cur == mainPointer.len - 1 && (mainPointer.elements.stage.find(".btn-slider-nav.prev").show(),
      mainPointer.elements.stage.find(".btn-slider-nav.next").hide()),
      setTimeout((function() {
          mainPointer.state = !1
      }
      ), 1e3),
...
, mainVisual = {
  ...
  init: function() {
      ...
      this.container.find(".main-visual-items").each((function() {
          ...
          0 == $(this).index() ? ($(this).addClass("actived"),
          gsap.set($(this), {
      ...
      this.container.find(".main-visual-items").on("mouseenter mouseleave", (function(e) {
          if (_this.container.hasClass("actived") && !mainVisual.state) {
              ...
              "mouseenter" == e.type ? ($element.hasClass("actived") || (gsap.to($number, {
                  duration: .4,
                  y: "-100%",
                  ease: Power2.easeOut
              }),
              ...
              _this.container.find(".main-visual-items").each((function() {
                  $element.hasClass("actived") ? $(this).hasClass("actived") ? gsap.to($(this), {
                      duration: .6,
              ...
              ))) : "mouseleave" == e.type && (gsap.to($number, {
                  duration: .4,
                  y: "0%",
                  ease: Power2.easeOut
              }),
      ...
      this.container.on("mouseleave", (function() {
          $(this).hasClass("actived") || _this.container.find(".main-visual-items").each((function() {
              $(this).hasClass("actived") ? gsap.to($(this), {
                  duration: .6,
  ...
  setSyle: function() {
      this.activeWidth = parseFloat(.9229 * this.container.width()),
      this.offWidth = parseFloat((this.container.width() - this.activeWidth) / (this.len - 1))
  },
  resize: function() {
      var _this = this;
      this.container.hasClass("actived") && (this.setSyle(),
      this.container.find(".main-visual-items").each((function() {
          $(this).hasClass("actived") ? gsap.to($(this), {
              duration: .6,
              width: _this.activeWidth,
  ...
  sliderNext: function() {
      mainVisual.state || (mainVisual.prev = mainVisual.cur,
  ...
  sort: function(index) {
      ...
      mainVisual.container.find(".main-visual-items").each((function() {
          var $element = $(this)
            , $number = $(this).find(".item-label .number")
            , $txt = $(this).find(".item-label .txt");
          $(this).index() == index ? ($(this).addClass("actived"),
          gsap.to($element, {
              duration: .6,
              width: _this.activeWidth,
              ease: Power2.easeOut
          ...
          "img" != _this.dataArr[$(this).index()] && _this.dataArr[$(this).index()].playVideo()) : ($(this).removeClass("actived"),
          gsap.to($element, {
              duration: .6,
              width: _this.offWidth,
              ease: Power2.easeOut
  ...
  dataSet: function() {
      var _this = this;
      $(".main-visual").find(".main-visual-items").each((function() {
          var $data;
          $data = $(this).find(".item-video").length > 0 ? null : "img",
      ...
      $(".main-visual").find(".main-visual-items").each((function() {
          if ($(this).find(".youtube-video").length > 0) {
              var $id = $(this).find(".youtube-video").attr("data-id")
                , $index = $(this).index();
              $(this).find(".item-video").append('<div class="cover"><img src="https://img.youtube.com/vi/' + $id + '/maxresdefault.jpg"/></div>'),
              _this.dataArr[$(this).index()] = new YT.Player($(this).find(".youtube-video")[0],{
                  ...
                  events: {
                      onReady: function(event) {
                          event.target.mute(),
                          0 == $index && event.target.playVideo()
                      },
                      onStateChange: function(event) {
                          0 == event.data && (event.target.clearVideo(),
...
var circularCardSlider = {
  ...
  init: function() {
      ...
      this.elements.data.querySelectorAll(".circular-slider-items").forEach((function(element, index) {
          ...
          thumbsCover.setAttribute("class", "item-cover"),
          thumbsCover.innerHTML = index,
          thumbs.append(thumbsCover);
          var $item = {
              element: element,
              index: index,
              thumb: thumbs
          ...
          _this.elements.thumbs.append(thumbs)
      }
      )),
      ...
      this.draggable = Draggable.create(this.elements.data, {
          ...
          onDragEnd: function() {
              ...
              circularCardSlider.cur = Math.floor(endValue(Math.abs(this.rotation)) / _this.step),
      ...
      $(document).on("click mouseenter mouseleave", ".circular-slider-square", (function(event) {
          var $element = $(this);
          "list" == circularCardSlider.state && ("mouseenter" == event.type ? ($element.addClass("enter"),
          gsap.to($element, {
              duration: .5,
              y: -50,
              ease: Power2.easeOut
          })) : "mouseleave" == event.type ? ($element.removeClass("enter"),
          gsap.to($element, {
              duration: .5,
              y: 0,
              ease: Power2.easeOut
  ...
  sliderNext: function() {
      circularCardSlider.draggableIsRotate || (circularCardSlider.cur = circularCardSlider.cur >= circularCardSlider.len - 1 ? circularCardSlider.len - 1 : circularCardSlider.cur = circularCardSlider.cur + 1,
      circularCardSlider.sliderSort(),
      circularCardSlider.draggableIsRotate = !0)
  },
  sliderPrev: function() {
      circularCardSlider.draggableIsRotate || (circularCardSlider.cur = 0 == circularCardSlider.cur ? 0 : circularCardSlider.cur = circularCardSlider.cur - 1,
      circularCardSlider.sliderSort(),
      circularCardSlider.draggableIsRotate = !0)
  },
  sliderSort: function() {
      circularCardSlider.curRotation = circularCardSlider.cur * circularCardSlider.step * -1,
      circularCardSlider.sliderRotation(),
      circularCardSlider.pageSet()
  },
  ...
  detailOpen: function(_obj) {
      var sqaureItem;
      "list" == circularCardSlider.state && (circularCardSlider.state = "detail",
      ...
      $(circularCardSlider.elements.data).find(".circular-slider-items").each((function() {
          var $sqaure = $(this).find(".circular-slider-square");
          $(this).index() == circularCardSlider.cur ? ($(this).addClass("actived"),
          sqaureItem = $sqaure,
          gsap.to($sqaure, {
              duration: .5,
              y: 0,
  ...
  detailClose: function() {
      "detail" == circularCardSlider.state && (circularCardSlider.state = "list",
...
function openPop(_url, _name, _width, _height) {
  return window.open(_url, _name, "width=" + _width + "px, height=" + _height + "px, top=0, left=0, resizable=yes, scrollbars=yes, location=no,  toolbar=no, status=no, menubar=no"),
  !1
}
